# Capability: Event Directory

## Purpose
The Event Directory capability allows community members to browse, search, and filter upcoming events, workshops, and talks. It serves as the primary entry point for users to discover community activities and navigate to registration or event details.
